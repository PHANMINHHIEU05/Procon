...
/** M14 fixed-forecast relative-margin objective over unchanged M11 search and M13.1 horizon. */
public final class RelativeMarginAwarePlanner implements DayPlanner {

    private final AnytimeTeamPlanner engine;

    public RelativeMarginAwarePlanner() {
    ...
    public RelativeMarginAwarePlanner(
        ...
        engine = new AnytimeTeamPlanner(
                ...
                AnytimeSearchPolicy.ANYTIME_STRATIFIED_RELATIVE_MARGIN_AWARE,
